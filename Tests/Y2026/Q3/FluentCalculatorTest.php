...
{
    public function testBasicValueTests(): void
    {
    ...
    public function testBasicOperationTests(): void
    {
    ...
    public function testMoreThanOneOperations(): void
    {
    ...
    public function testShouldThrowInvalidInputException1(): void
    {
        $this->expectException(InvalidInputException::class);
        // @phpstan-ignore method.notFound
        FluentCalculator::init()->limit();
    }
    public function testShouldThrowInvalidInputException2(): void
    {
        $this->expectException(InvalidInputException::class);
        // @phpstan-ignore method.notFound
        FluentCalculator::init()->power();
    }
    public function testShouldThrowInvalidInputException3(): void
    {
        $this->expectException(InvalidInputException::class);
        // @phpstan-ignore method.notFound
        FluentCalculator::init()->sin();
    }
    public function testShouldThrowInvalidInputException4(): void
    {
        $this->expectException(InvalidInputException::class);
        // @phpstan-ignore method.notFound
        FluentCalculator::init()->cos();
    }
    public function testShouldThrowDigitCountOverflowException1(): void
    {
    ...
    public function testShouldThrowDigitCountOverflowException2(): void
    {
        $this->expectException(DigitCountOverflowException::class);
        FluentCalculator::init()->one->two->three->four->five->six->seven->eight->nine->times->one->two();
    }
    public function testShouldThrowDigitCountOverflowException3(): void
    {
        $this->expectException(DigitCountOverflowException::class);
        FluentCalculator::init()->nine->nine->nine->nine->nine->nine->nine->nine->nine->plus->one();
    }
    public function testShouldThrowDigitCountOverflowException4(): void
    {
        $this->expectException(DigitCountOverflowException::class);
        FluentCalculator::init()->one->zero->zero->zero->zero->zero->times->one->zero->zero->zero->zero->zero();
    }

    public function testDigitCountOverflow_NumberTwoTooManyDigits(): void
    {
        $this->expectException(DigitCountOverflowException::class);
        FluentCalculator::init()->one->dividedBy->one->zero->zero->zero->zero->zero->zero->zero->zero->zero();
    }

    public function testDivisionRounding_NegativeNumbers(): void
    {
        $this->assertSame(-1, FluentCalculator::init()->minus->three->dividedBy->two());
    }

    public function testNegativeResult_NineDigits_ShouldNotOverflow(): void
    {
        $this->assertSame(-999999999, FluentCalculator::init()->minus->nine->nine->nine->nine->nine->nine->nine->nine->nine());
    }

    public function testChainWithOperatorOverwritesAndFinalOperatorCall(): void
    {
        $this->assertSame(
            34875,
            FluentCalculator::init()->four->minus->zero->plus->one->times->nine->three->times->seven->five->plus->minus->times()
        );
    }
}
